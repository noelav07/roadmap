...
#             content: "";
#             position: absolute;
#             top: -15px; /* Position above the text */
#             left: 50%;
...
#     st.markdown("<div class='chart-heading'>IT Jobs Salary and Demand Comparison</div>", unsafe_allow_html=True)
...
#     st.markdown("<div class='chart-heading'>Job Demand Distribution</div>", unsafe_allow_html=True)
